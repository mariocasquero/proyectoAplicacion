<form method="post" action="<?php echo $_SERVER["PHP_SELF"]?>" id="fModificarDep">
    <fieldset>
        <legend><?php echo MODDEP?></legend>
        ...
        <input type="text" name="descDepartamento" id="descDepartamento" value="<?php echo $departamento->getDescDepartamento();?>" size="30"><br><br>
        <label class="errores"><?php echo $aErrores["descDepartamento"];?></label><br>
        
        <label><?php echo VOLUMEN?></label>
        <input type="text" name="volNegocio" id="volNegocio" value="<?php echo $departamento->getVolumenDeNegocio();?>" size="30"><br><br>
        <label class="errores"><?php echo $aErrores["volNegocio"];?></label><br>
        
        <input type="submit" name="modificarDep" id="modificarDep" value="<?php echo MOD?>">
