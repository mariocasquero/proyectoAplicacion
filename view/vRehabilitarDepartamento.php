<form method="post" action="<?php echo $_SERVER["PHP_SELF"]?>" id="fRehabilitar">
    <fieldset>
        <legend><?php echo REDEP?></legend>
        ...
        <input type="text" name="fechaBaja" id="fechaBaja" value="<?php echo $fechaBaja?>" size="30" disabled><br><br>
        
        <input type="submit" name="rehabilitar" id="rehabilitar" value="<?php echo REHAB?>">
