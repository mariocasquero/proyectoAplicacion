<form method="post" action="<?php echo $_SERVER["PHP_SELF"]?>" id="fModificarPer">
    <fieldset>
        ...
        <input type="text" name="descUsuario" id="descUsuario" value="<?php echo $usuario->getDescUsuario();?>" size="30"><br><br>
        <label class="errores"><?php echo $aErrores["descUsuario"];?></label><br>
        
        <label><?php echo PERFIL?></label>
        <input type="text" name="perfil" id="perfil" value="<?php echo $usuario->getPerfil();?>" size="30" disabled><br><br>
        <label class="errores"><?php echo $aErrores["perfil"];?></label><br>
        
        <input type="submit" name="modificarPer" id="modificarPer" value="<?php echo MOD?>">
