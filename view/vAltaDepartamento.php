<form method="post" action="<?php echo $_SERVER["PHP_SELF"]?>" id="fAltaDep">
    <fieldset>
        <legend><?php echo ALTADEP?></legend>
        
        <label><?php echo CODDEP?></label>
        <input type="text" name="codDepartamento" id="codDepartamento" value="<?php echo $_REQUEST["codDepartamento"]?>" size="30"><br><br>
        <label class="errores"><?php echo $aErrores["codDepartamento"];?></label><br>

        <label><?php echo DESCRIPCIONDEP?></label>
        <input type="text" name="descDepartamento" id="descDepartamento" value="<?php echo $_REQUEST["descDepartamento"]?>" size="30"><br><br>
        <label class="errores"><?php echo $aErrores["descDepartamento"];?></label><br>

        <label><?php echo VOLUMEN?></label>
        <input type="text" name="volNegocio" id="volNegocio" value="<?php echo $_REQUEST["volNegocio"]?>" size="30"><br><br>
        <label class="errores"><?php echo $aErrores["volNegocio"];?></label><br>

        <input type="submit" name="anyadirDep" id="anyadirDep" value="<?php echo ACEPTAR?>">
        <input type="submit" name="cancelarDep" id="cancelarDep" value="<?php echo CANCELAR?>">
    </fieldset>
</form>
